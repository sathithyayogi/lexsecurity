...
class CreateDevicesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('devices', function (Blueprint $table) {
            ...
            $table->time('alarmonetotTime')->nullable()->default('00:00:00');
            $table->time('alarmtwototTime')->nullable()->default('00:00:00');
            $table->integer('alarmonetimeday')->nullable();
            $table->integer('alarmtwotimeday')->nullable();
